...
export const S0Cover: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-mono text-xs uppercase tracking-[0.25em] text-ink-60 border-b border-ink/20 pb-1">
          {content.eyebrow}
        </span>
      </motion.div>
      ...
      <div className="relative z-10 max-w-2xl mx-auto my-auto flex flex-col items-center">
        ...
        <motion.div
          ...
          transition={{ duration: 0.64, delay: 0.1, ease: EASINGS.stamp }}
          className="mb-8"
        >
          <Coin size={130} />
        </motion.div>
        ...
        <motion.h1
          ...
          className="font-serif text-5xl sm:text-7xl font-normal tracking-tight text-ink mb-6"
        >
          {content.title}
        </motion.h1>
        ...
        <motion.p
          ...
          className="font-serif text-base sm:text-lg text-ink-60 leading-relaxed max-w-[34ch] mx-auto mb-10"
        >
          {content.sub}
        </motion.p>
      </div>
      ...
      <div className="relative z-10 w-full flex items-center justify-center">
        <button
          ...
          className="group flex flex-col items-center gap-2 text-ink transition-colors focus-visible:outline-gold"
          aria-label="Scroll to enter the economy"
        >
          <span className="font-mono text-xs sm:text-sm tracking-widest uppercase font-medium">
            {content.cta}
          </span>
          <span className="h-[1.5px] w-16 bg-gold transition-all duration-900 group-hover:w-28 animate-[pulse_900ms_ease-in-out_infinite]" />
        </button>
      </div>
      ...
      {mounted && (
        <div className="absolute bottom-6 right-6 sm:bottom-10 sm:right-12 z-20 pointer-events-none">
          <WaxSeal text="STANDARD" subtext="RESERVE" size={78} animateStamp />
        </div>
      )}
    </section>
  );
